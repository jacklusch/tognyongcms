...
describe('category tree', () => {
  it('listCategories 返回树（children 嵌套）与扁平 all 对应', () => {
    const items: CategoryItem[] = [
      {
        id: 1, parent_id: 0, name: '产品中心', slug: 'product', description: '', content_count: 0,
        children: [{ id: 2, parent_id: 1, name: '斩拌机', slug: 'emulsifier', description: '', content_count: 0, children: [] }],
      },
    ]
...
describe('category delete guard', () => {
  const base: CategoryItem = { id: 1, parent_id: 0, name: 'x', slug: 'x', description: '', content_count: 0, children: [] }
  ...
  it('有内容 → 提示先移除内容', () => {
    const c: CategoryItem = { ...base, content_count: 3 }
